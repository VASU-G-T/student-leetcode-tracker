...
export default function DifficultyChart({ easy = 0, medium = 0, hard = 0, title = 'Difficulty Distribution' }) {
  ...
  const data = [
    { name: 'Easy', value: easy, color: '#00b8a3', bgClass: 'text-emerald-400' },
    { name: 'Medium', value: medium, color: '#ffc01e', bgClass: 'text-amber-400' },
    { name: 'Hard', value: hard, color: '#ff375f', bgClass: 'text-rose-400' }
  ];
  ...
  return (
    <div className="glass-card p-5 flex flex-col justify-between">
      <div>
        ...
        <p className="text-xs text-slate-400">Aggregated breakdown by problem complexity</p>
      </div>
        ...
        <div className="my-3 flex flex-col sm:flex-row items-center gap-4">
          ...
          <div className="w-40 h-40 relative flex items-center justify-center">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
              ...
              <span className="text-[10px] text-slate-400 uppercase tracking-widest mt-0.5 font-medium">Solved</span>
            </div>
          </div>
          ...
          <div className="flex-1 w-full space-y-2.5">
            <div className="flex items-center justify-between p-2 rounded-lg bg-slate-950/40 border border-slate-800/80">
              ...
              <div className="flex items-center gap-3">
                <span className="text-xs font-bold text-white font-mono">{easy}</span>
                <span className="text-xs font-medium text-emerald-400 font-mono w-10 text-right">{easyPct}%</span>
              </div>
            </div>
            ...
            <div className="flex items-center justify-between p-2 rounded-lg bg-slate-950/40 border border-slate-800/80">
              ...
              <div className="flex items-center gap-3">
                <span className="text-xs font-bold text-white font-mono">{medium}</span>
                <span className="text-xs font-medium text-amber-400 font-mono w-10 text-right">{medPct}%</span>
              </div>
            </div>
            ...
            <div className="flex items-center justify-between p-2 rounded-lg bg-slate-950/40 border border-slate-800/80">
              ...
              <div className="flex items-center gap-3">
                <span className="text-xs font-bold text-white font-mono">{hard}</span>
                <span className="text-xs font-medium text-rose-400 font-mono w-10 text-right">{hardPct}%</span>
              </div>
            </div>
          </div>
        </div>
