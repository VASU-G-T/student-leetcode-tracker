/**
 * LeetCode Problem Detection & Parsing Engine
 * Inspects GitHub repository tree / file structures generated by LeetSync, LeetHub, or manual repos.
 */
...
/**
 * Determine difficulty from path / folder / filename
 */
function detectDifficulty(path, filename, problemNumber) {
  ...
  // Fallback to known list if available
  if (problemNumber && KNOWN_DIFFICULTIES[problemNumber]) {
    return KNOWN_DIFFICULTIES[problemNumber];
  }
